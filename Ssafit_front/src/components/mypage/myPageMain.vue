    ...
    <div class="container mt-5">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <strong>별명 :</strong> {{ userInfo.nickname }}
          </p>
      ...
      <div class="d-flex justify-content-between">
        ...
        <button class="btn btn-danger flex-fill mx-1" @click="goToJjimList">
          영상 찜 목록
        </button>
        <button class="btn btn-primary flex-fill mx-1" @click="goToCommentList">
          작성 댓글 목록
        </button>
        <button class="btn btn-success flex-fill mx-1" @click="goToFriends">
          친구 추가/목록
        </button>
      </div>
    </div>
